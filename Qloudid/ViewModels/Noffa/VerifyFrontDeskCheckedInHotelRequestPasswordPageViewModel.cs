...
{
	public class VerifyFrontDeskCheckedInHotelRequestPasswordPageViewModel : BaseViewModel
	{
		#region Constructor.
		public VerifyFrontDeskCheckedInHotelRequestPasswordPageViewModel(INavigation navigation)
		{
		...
		private async Task ExecuteVerifyInterAppPasswordCommand()
		{
			if (!string.IsNullOrWhiteSpace(Password))
			{
				...
				else if (response.Result == 1)
				{
					...
					int hotelServiceResponse = await hotelService.GetFrontDeskCheckedInHotelAsync(FrontDeskCheckedInHotelRequestInfo);
					...
					if (Device.RuntimePlatform == Device.iOS)
					{
						...
						else if (Helper.Helper.AppToAppName.Equals("NoffaPlusApp"))
		...
		public Models.FrontDeskCheckedInHotelRequest FrontDeskCheckedInHotelRequestInfo { get; set; }
		#endregion
	}
}
