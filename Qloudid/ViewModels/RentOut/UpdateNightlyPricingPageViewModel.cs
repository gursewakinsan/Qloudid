...
{
    public class UpdateNightlyPricingPageViewModel : BaseViewModel
	{
		#region Constructor.
		public UpdateNightlyPricingPageViewModel(INavigation navigation)
		{
        ...
        {
			PricingTitle = UpdateSelectedNightlyPricing.PricingTitle;
			IsMondayOpen = UpdateSelectedNightlyPricing.MondayOpen;
			IsTuesdayOpen = UpdateSelectedNightlyPricing.TuesdayOpen;
			IsWednesdayOpen = UpdateSelectedNightlyPricing.WednesdayOpen;
			IsThursdayOpen = UpdateSelectedNightlyPricing.ThursdayOpen;
			IsFridayOpen = UpdateSelectedNightlyPricing.FridayOpen;
			IsSaturdayOpen = UpdateSelectedNightlyPricing.SaturdayOpen;
			IsSundayOpen = UpdateSelectedNightlyPricing.SundayOpen;
			ShortestDuration = UpdateSelectedNightlyPricing.ShortestDuration;
			MondayPrice = UpdateSelectedNightlyPricing.MondayPrice;
			TuesdayPrice = UpdateSelectedNightlyPricing.TuesdayPrice;
			WednesdayPrice = UpdateSelectedNightlyPricing.WednesdayPrice;
			ThursdayPrice = UpdateSelectedNightlyPricing.ThursdayPrice;
			FridayPrice = UpdateSelectedNightlyPricing.FridayPrice;
			SaturdayPrice = UpdateSelectedNightlyPricing.SaturdayPrice;
			SundayPrice = UpdateSelectedNightlyPricing.SundayPrice;
			DiscountForSeven = UpdateSelectedNightlyPricing.DiscountForSeven;
		}
        #endregion
		...
		#region Update Pricing Command.
		private ICommand updatePricingCommand;
		public ICommand UpdatePricingCommand
		{
			get => updatePricingCommand ?? (updatePricingCommand = new Command(async () => await ExecuteUpdatePricingCommand()));
		}
		private async Task ExecuteUpdatePricingCommand()
		{
			...
			else
			{
				...
				await service.UpdatePricingAsync(request);
		...
		private Models.NightlyPricingListResponse updateSelectedNightlyPricing;
		public Models.NightlyPricingListResponse UpdateSelectedNightlyPricing
		{
			get => updateSelectedNightlyPricing;
			set
			{
				updateSelectedNightlyPricing = value;
				OnPropertyChanged("UpdateSelectedNightlyPricing");
			}
		}
