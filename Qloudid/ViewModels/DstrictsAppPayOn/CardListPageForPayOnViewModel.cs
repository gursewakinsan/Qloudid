...
{
	public class CardListPageForPayOnViewModel : BaseViewModel
	{
		#region Constructor.
		public CardListPageForPayOnViewModel(INavigation navigation)
		{
		...
		{
			Helper.Helper.SelectedCardId = cardId;
			DependencyService.Get<IProgressBar>().Show();
			...
			if (response == 0)
				...
				Application.Current.MainPage = new NavigationPage(new Views.DstrictsAppPayOn.VerifyPayForPayOnPasswordPage());
			DependencyService.Get<IProgressBar>().Hide();
		}
		#endregion
