...
{
	public class CompanyAndUserAddressPageViewModel : BaseViewModel
	{
		#region Constructor.
		public CompanyAndUserAddressPageViewModel(INavigation navigation)
		{
		...
		private async Task ExecuteSubmitSelectedCompanyCommand()
		{
			...
			foreach (var companies in ListOfCompany)
			{
				...
				if (company != null)
				{
					Helper.Helper.UserOrCompanyAddress = company.id > 1 ? 2 : 1;
