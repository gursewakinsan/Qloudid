...
{
    public class VerifyHabitantPasswordPageViewModel : BaseViewModel
    {
		#region Constructor.
		public VerifyHabitantPasswordPageViewModel(INavigation navigation)
		{
		...
		{
			get => cancelCommand ?? (cancelCommand = new Command( () =>  ExecuteCancelCommand()));
		}
		...
		private async Task ExecuteVerifyInterAppPasswordCommand()
		{
			if (!string.IsNullOrWhiteSpace(Password))
			{
				...
				{
					IAparmentService aparmentService = new AparmentService();
					await aparmentService.CheckinAparmentOwnerAsync(new Models.CheckinAparmentOwnerRequest()
					{
						Id = HabitantId,
