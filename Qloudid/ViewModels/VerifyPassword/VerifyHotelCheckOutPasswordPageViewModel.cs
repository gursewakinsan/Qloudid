...
{
	public class VerifyHotelCheckOutPasswordPageViewModel : BaseViewModel
	{
		#region Constructor.
		public VerifyHotelCheckOutPasswordPageViewModel(INavigation navigation)
		{
		...
		private async Task ExecuteVerifyInterAppPasswordCommand()
		{
			if (!string.IsNullOrWhiteSpace(Password))
			{
				...
				else if (response.Result == 1)
				{
					...
					await hotelService.CheckOutGuestAsync(new Models.CheckOutGuestRequest()
					{
						Id = HotelCheckOutId
					});
