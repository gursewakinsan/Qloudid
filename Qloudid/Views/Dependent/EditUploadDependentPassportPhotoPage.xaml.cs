...
namespace Qloudid.Views.Dependent
{
	...
	public partial class EditUploadDependentPassportPhotoPage : ContentPage
	{
		int index = 0;
		ImageSource _imageSource;
		private IMedia _mediaPicker;
		EditUploadDependentPassportPhotoPageViewModel viewModel;
		public EditUploadDependentPassportPhotoPage()
		{
			InitializeComponent();
			NavigationPage.SetBackButtonTitle(this, "");
			BindingContext = viewModel = new EditUploadDependentPassportPhotoPageViewModel(this.Navigation);
			viewModel.BindDataWithViewCommand.Execute(null);
		}
