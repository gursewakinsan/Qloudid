namespace Qloudid.Service
{
	public class EndPointsList
	{
		...
		public const string UpdateLoginIpUrl = "http://www.qloudid.com/user/index.php/QloudidApp/updateLoginIp/{0}";
		public const string VerifyPasswordUrl = "http://www.qloudid.com/user/index.php/QloudidApp/verifyPassword/{0}";
	}
}
